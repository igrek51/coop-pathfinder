...
public class ModuleController {
	...
	Grid grid;
	Map<Integer, PathPanel.Point> unitPositions = new HashMap<>();
	Map<Integer, NodePool.Point> unitTargets = new HashMap<>();
	
	public ModuleController(ModulePresenter presenter, SimulationParams params) {
	...
	void createMobileRobot(Point point, int i) {
