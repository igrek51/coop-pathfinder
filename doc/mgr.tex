...
\uczelniaLogo{img/pw-logo.pdf}
\wydzial{Wydział Mechatroniki}
\instytut{Instytut Automatyki i Robotyki}
\rok{2017}
\promotor{prof. nzw. dr hab. Barbara Siemiątkowska}
\temat{Planowanie bezkolizyjnych tras dla zespołu robotów mobilnych}
\autor{Ireneusz Szulc}
\miasto{Warszawa}
%==============================================
