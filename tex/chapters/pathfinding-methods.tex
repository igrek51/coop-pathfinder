...
Popularne podejścia unikające planowania w wysoko wymiarowej zbiorowej przestrzeni konfiguracyjnej to techniki rozproszone i priorytetyzowane \cite{optpriorities}.
...
% TODO-MGR
% W artykule \cite{optpriorities} przedstawione zostało podejście do optymalizowania układu priorytetów dla rozproszonych i priorytetyzowanych technik planowania.
...
\subsection{Priorytetyzowane planowanie}
Często używaną w praktyce metodą jest planowanie priorytetyzowane. 
...
\begin{figure}
	...
	\caption{Sytuacja, w której żadne rozwiązanie nie zostanie znalezione, stosując priorytetyzowane planowanie, jeśli robot 1 ma wyższy priorytet niż robot 2. Źródło: \cite{optpriorities}}
...
Jedną z metod rozproszonego i priorytetyzowanego planowania tras jest Path Coordination, której idea przedstawia się w następujących krokach \cite{optpriorities}:
\begin{enumerate}
