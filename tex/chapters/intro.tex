...
Przedmiotem niniejszej pracy jest przegląd metod wykorzystywanych do planowania bezkolizyjnych tras dla wielu robotów.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{img/robopath/sample-maze}
