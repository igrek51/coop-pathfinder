...
Zbadano skuteczność metody WHCA* bez dynamicznego przydziału priorytetów w zależności od wielkości stałego okna czasowego.
...
Zgodnie z oczekiwaniami jest to funkcja monotonicznie rosnąca
