...
2) w przypadkach gdzie LRA* się udało, wykres 4 algorytmów (serie), z labiryntem:
	z labirytntem:
		- w funkcji liczby robotów (15x15) (1-30) * 100 symulacji (3000 sym)
			- liczba kroków
			- czas planowania
				lra-steps-maze-robots
		- w funkcji rozmiaru mapy (5 robotów) (3x3 - 40x40) * 100 symulacji
			- liczba kroków
			- czas planowania
				lra-steps-maze-mapsize
...
3) w przypadkach gdzie WHCA*1 się udało, wykres 3 algorytmów (serie), z labiryntem:
	z labirytntem:
		- w funkcji liczby robotów (15x15) (1-30) * 100 symulacji (3000 sym)
			- liczba kroków
			- czas planowania
				whca1-steps-maze-robots
		- w funkcji rozmiaru mapy (5 robotów) (3x3 - 40x40) * 100 symulacji
			- liczba kroków
			- czas planowania
				whca1-steps-maze-mapsize
