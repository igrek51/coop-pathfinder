...
\usepackage{amssymb} % sybmol varnothing
\usepackage{booktabs} % multicolumns
...
% alogirthm pseudocode embedded
\usepackage[Algorytm,section]{algorithm}
\usepackage{algpseudocode} %algorithmicx
\algdef{SE}[SUBALG]{Indent}{EndIndent}{}{\algorithmicend\ }%
\algtext*{Indent}
\algtext*{EndIndent}
% \algblock[]{StartBlock}{EndBlock}
